...
// Deux variantes :
// - featured={true} → grande carte noire avec image en haut (col gauche homepage)
// - featured={false} → carte blanche standard (col droite + page shop)
...
export default function ProductCard({ product: p, onAdd, featured = false }: Props) {
  ...
  // ── Carte Featured (grande, fond noir) ───────────────────────────────────
  if (featured) {
    return (
      <div className="card-featured">
        ...
        >
          ...
          <div style={{
            ...
            background: "linear-gradient(to bottom,transparent 35%,rgba(10,10,10,.88) 100%)",
          }} />
          {/* Top row — tag + code */}
          <div style={{
        ...
        {/* Corps de la carte */}
        <div style={{
          padding: "20px 20px 24px", background: "var(--ink)", flex: 1,
          display: "flex", flexDirection: "column", gap: 14,
        }}>
          <p style={{ fontFamily: "var(--body)", fontSize: 13, color: "rgba(255,255,255,.5)", lineHeight: 1.65, fontWeight: 300 }}>
            {p.desc}
          </p>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "16px 18px 20px", flex: 1, display: "flex", flexDirection: "column", gap: 11 }}>
        <p style={{ fontFamily: "var(--body)", fontSize: 12.5, color: "var(--muted)", lineHeight: 1.6, fontWeight: 300, flex: 1 }}>
          {p.desc}
        </p>
